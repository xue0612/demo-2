...
$(document).ready(function(){
		...
		if(cpage<=10){
			for(var i=1;i<=cpage;i++){
				if(i==nowpage){
					strhtml+='<a href=ope_user?pageStart='+psize*(i-1)+'&userName='+userName+' style="background-color:#aaaaaa;font-weight:700">'+i+'</a>';
				}else{
					strhtml+='<span> <a href=ope_user?pageStart='+psize*(i-1)+'&userName='+userName+'>'+i+'</a></span>';
				}
			}
		}
		else if(cpage>10){
